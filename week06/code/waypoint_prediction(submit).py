...
def waypoint_prediction(roadside1_spline, roadside2_spline, num_waypoints=6, way_type = "center"):
    ...
    if way_type == "center":
        ...
        center = (roadside1_points + roadside2_points)/2
        #print("center")
        #print(center)
        way_points = np.array(center)
        #print(way_points)
...
def target_speed_prediction(waypoints, num_waypoints_used=5,
    ...
    '''
    #print(waypoints[0])
    target_speed = (max_speed - min_speed)*np.exp(-exp_constant*abs(num_waypoints_used-2-curvature(waypoints))) + min_speed
    return target_speed